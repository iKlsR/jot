/*
*       This was taken from http://www.jroller.com/DhilshukReddy/entry/custom_jtabbedpane
*       http://www.jroller.com/DhilshukReddy/resource/CustomTabbedPanes/AquaBarTabbedPaneUI.java
...
public class JotTabbedPaneUI extends BasicTabbedPaneUI {
    ...
    public static ComponentUI createUI(JComponent c) {
        return new JotTabbedPaneUI();
    }

    public JotTabbedPaneUI() {
    ...
    protected void paintTabArea(Graphics g, int tabPlacement, int selectedIndex) {
        ...
        g2d.setPaint(
            new GradientPaint(0, 10, defaultColorSet.bottomGradColor1, 0, 21, defaultColorSet.bottomGradColor2)
        );
